...
% here I want to describe that there are a number of ways of developing an Android application. Or a number of frameworks that can be used.
% I then go on explaining what how the frameworks are different. What are the disadvantage of a one framework type compared to antoher framework type. 
% Lastly I go more into detail of a framework which works a bit differently then PhoneGap. 
