...
%Today users expect brand name companies or organizations to have a mobile application to make interaction with the company or organization easier. Mobile application 

% Mobile appears to be identified as a critical part of an overall brand experience, and the survey results revealed that 76\% of mobile application users agree that all brand name companies and organizations should have mobile apps to make shopping or interacting with them easier. (http://www.effectiveui.com/company/newsroom/press-releases/11-10-2010/)
