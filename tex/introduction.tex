...
In the book “Software Sizing, Estimation, and Risk.Management” Daniel D. Galorath and Michael W. Evans writes about source lines of code as a measurement tool. Source lines of code, also abbreviated as SLOC, is very easy to obtain and is a fairly accurate predictor of development effort\cite[p.~63]{galorath2006}. There are many different ways to measure SLOC, such as Halsted’s approach, function points, physical SLOC and Logical SLOC. 
...
To compare size between two different languages a size conversion table can be used. The table can be used to estimate how many SLOC a program coded one programming language would have to be written in another language. You can compare a third generation language, a fourth generation language, Ada, Assembly or Pascal. A third generation language compared to another third generation language would have no conversion rate\cite[p.~163]{galorath2006}. 
