\begin{abstract}
Mobile applications are today an important way for companies to reach their customers. Developing a mobile application could require a lot of resources, especially if the application is to be made from scratch. However, an alternative for a company with an existing web application, is to create a hybrid mobile application, making use of the logic in the existing web application.
